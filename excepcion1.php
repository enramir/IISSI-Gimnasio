...
?>	
	...
	<div>
		...
		<?php } else { ?>
		<h4>¡NICKNAME O CONTRASEÑA INCORRECTA!</h4>
		<p>El nickname o la contraseña no es correcta. Pulse <a href="../GYM_ACTUALIZADO/login.php">aquí</a> para intentarlo de nuevo.</p>
		<?php } ?>
	</div><br><br>
