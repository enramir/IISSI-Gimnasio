<?php
	...
	require_once'gestionarPistas.php';
	...
	else  header("Location: form_alta_pistas.php");
...
<body>
	...
	<main>
		...
		<?php 	// AQUÍ SE INVOCA A LA FUNCIÓN DE ALTA DE USUARIO
		        ...
		        $codigo_retorno = alta_pistas($conn,$form_user); 
		        //Alta SQL de usuario
		        if($codigo_retorno==0){ //El alta se ha producido
		?>
				<!-- MENSAJE DE BIENVENIDO AL USUARIO -->
				<h4>Enhorabuena, La pista ha sido creada correctamente.
			    </h4>
			    <div>
		...
		<?php } else { //Usuario duplicado ?>
				...
				<h4>¡Lo siento! error al crear la pista, <?php echo $form_user["pista"]?> - NºPista:<?php echo $form_user["numpista"]?> ya existe
			    </h4>
			    <div>
			    	<a href="form_alta_pistas.php">Pulse aquí para probar con otros datos!</a>
			    </div>
		<?php } ?>
