<?php
	...
	else  header("Location: realizar_reserva.php");
...
<head>
  <meta charset="utf-8">
  <title>Gestión del Gimnasio: Alta de la reserva realizada con éxito</title>
...
<body>
	...
	<main>
		...
		<?php 	// AQUÍ SE INVOCA A LA FUNCIÓN DE ALTA DE USUARIO
		        ...
		        $codigo_retorno = registrar_reserva_qa($conn,$form_user); 
		        //Alta SQL de usuario
		        //$codigo_retorno_1 = alta_cliente($conn,$form_user);
		        if(($codigo_retorno)==0){ //El alta se ha producido
		?>
				<!-- MENSAJE DE BIENVENIDO AL USUARIO -->
				<h4>¡Enhorabuena <?php echo $form_user["nickname"] ?>!
					Ya has realizado la reserva con éxito.
			    </h4>
			    <div>
		...
		<?php } else { //Usuario duplicado ?>
				...
				<h4>¡Lo siento! pista ya reservada.
			    </h4>
			    <div>
			    	<a href="realizar_reserva.php">Pulse aquí para probar con otra pista!</a>
			    </div>
		<?php } ?>
